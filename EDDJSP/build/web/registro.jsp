                    ...
                    <form name="sentMessage" id="contactForm" novalidate>
                        ...
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="password" class="form-control" placeholder="Confirmar Contraseña" id="confi" required data-validation-required-message="Please enter your contraseña.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>  
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                ...
                                <input type="text" class="form-control" placeholder="Nombre completo" id="name" required data-validation-required-message="Please enter your name.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>                        
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label for="empre">Empresa para la que trabaja</label>
                                <input type="text" class="form-control" placeholder="Empresa para la que trabaja" id="empre" required data-validation-required-message="Please enter your empresa.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>                           
                        <div class="row control-group">
                            <div class="form-group col-xs-12 floating-label-form-group controls">
                                <label for="depto">Departamento en el que trabaja</label>
                                <input type="text" class="form-control" placeholder="Departamento en el que trabaja" id="depto" required data-validation-required-message="Please enter your department en el que trabaja.">
                                <p class="help-block text-danger"></p>
                            </div>
                        </div>                                                
                        <br>
